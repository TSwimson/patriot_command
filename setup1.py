...
VERSION = '1.0'
AUTHOR_NAME = 'Tanner'
AUTHOR_EMAIL = 'TannerSwenson@gmail.com'
AUTHOR_URL = ""
PRODUCT_NAME = "Patriot Command"
SCRIPT_MAIN = 'Patriot_Command_oop.py'
...
extra_files = [ ("",['readme.txt']),
                   ...
                   ("gfx",glob.glob(os.path.join('gfx','*.bmp'))),
                   #("gfx",glob.glob(os.path.join('gfx','*.png'))),
                   ("fonts",glob.glob(os.path.join('fonts','*.ttf'))),
                   #("music",glob.glob(os.path.join('music','*.oog'))),
